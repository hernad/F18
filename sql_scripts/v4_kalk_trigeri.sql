...
AS $$
BEGIN
   IF ( OLD.idvd IN ('49','71', '72', '22', '29', '79', 'IP') ) and NOT current_user IN ('postgres', 'admin') THEN
       RAISE EXCEPTION '29, 49, 71, 72, 22, 79, IP nije dozvoljeno brisanje % : % - % - %', current_user, OLD.idvd, OLD.brdok, OLD.datdok;
   END IF;
