...
CREATE OR REPLACE RULE public_pos_doks_knjig_ins AS ON INSERT TO {{ item_prodavnica }}.pos_doks_knjig
      DO INSTEAD INSERT INTO {{ item_prodavnica }}.pos_knjig(
        idpos, idvd, brdok, datum, idpartner,
        idradnik, idvrstep, vrijeme, ukupno, brfaktp, opis, dat_od, dat_do
      ) VALUES (
...
CREATE OR REPLACE RULE public_pos_pos_knjig_ins AS ON INSERT TO {{ item_prodavnica }}.pos_pos_knjig
