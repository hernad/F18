...
IF (TG_OP = 'DELETE') THEN
      ...
      EXECUTE 'DELETE FROM p15.pos WHERE idpos=$1 AND idvd=$2 AND brdok=$3 AND datum=$4'
...
DROP TRIGGER IF EXISTS pos_knjig_crud on p15.pos_knjig;
CREATE TRIGGER pos_knjig_crud
      AFTER INSERT OR DELETE OR UPDATE
      ON p15.pos_knjig
      FOR EACH ROW EXECUTE PROCEDURE p15.on_pos_knjig_crud();

ALTER TABLE p15.pos_knjig ENABLE ALWAYS TRIGGER pos_knjig_crud;
